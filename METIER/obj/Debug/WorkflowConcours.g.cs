...
namespace METIER {
    ...
    public partial class WorkflowConcours : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(WorkflowConcours).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(WorkflowConcours));
        ...
        private string FindResource() {
            string[] resources = typeof(WorkflowConcours).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".WorkflowConcours.g.xaml") || resource.Equals("WorkflowConcours.g.xaml"))) {
                    return resource;
                }
            }
